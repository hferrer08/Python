...
pais=(input("Digite un país que desee saber la capital: "))
letra = pais.capitalize in diccionario #Si el elemento esta en el diccionario
if(letra==True):
    print(diccionario[pais.capitalize()])
else:
    print("El país solicitado no se encuentra en el diccionario")
